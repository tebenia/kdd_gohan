...
22. For computed numeric answers such as percentages, ratios, averages, or formula results, return the raw numeric value with full precision. Do not add `%`, units, symbols, or rounded display strings unless the question explicitly asks for that formatting.
